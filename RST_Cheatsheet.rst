...
Section Structure (title and headings)
--------------------------------------
...
Inline Markup (bold, italics, links, etc.)
--------------------------------------------
...
| ::                                                       |                                                |
|                                                          |                                                |
|    `link with text <http://docutils.sf.net/>`_           | `link with text <http://docutils.sf.net/>`_    |
+----------------------------------------------------------+------------------------------------------------+
| ::                                                       |                                                |
|                                                          |                                                |
|    `link to local </README.rst>`_                        | `link to local </README.rst>`_                 |
+----------------------------------------------------------+------------------------------------------------+
| ::                                                       |                                                |
|                                                          |                                                |
|    `link from subfolder <../README.rst>`_                | `link from subfolder <../README.rst>`_         |
|                                                          | note this wont work as this is in the top dir  |
+----------------------------------------------------------+------------------------------------------------+
...
tables are easy to create but limited (no row spans, etc.).  The easiest way to create a table is to start with a
spreadsheet program (excel, google sheets, etc.) and then use https://tableconvert.com/restructuredtext-generator
to convert it to reStructuredText.
...
+---------------------------------------+--------------------------------------------------------------------------+
| modified from Roberto Alsina:         | https://github.com/ralsina/rst-cheatsheet/blob/master/rst-cheatsheet.rst |
+---------------------------------------+--------------------------------------------------------------------------+
